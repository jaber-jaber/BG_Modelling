...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 3;
 	...
 	ivoc_help("help ?1 GABAa_S /Users/jaberjaber/BG_Modelling/Destexhe_GABAa.mod\n");
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 110 in file Destexhe_GABAa.mod:\n	SOLVE release\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/jaberjaber/BG_Modelling/Destexhe_GABAa.mod";
static const char* nmodl_file_text = 
