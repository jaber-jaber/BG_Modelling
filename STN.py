...
class STN(Cell):
    ...
    def define_biophysics(self):
        ...
        self.soma.gkcabar_stn = 0.7e-3 # AHP Ca2+-dependent K channel, changed to Otsuka's.
        ...
        self.soma.gl_stn = 0.29e-3 # Leak current, changed to Otsuka's. Original value: 0.29e-3 S/cm^2
