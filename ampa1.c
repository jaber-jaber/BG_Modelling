...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 4;
 	...
 	ivoc_help("help ?1 AMPA_S ampa1.mod\n");
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 44 in file ampa1.mod:\n    SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "ampa1.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "    : Point process describing glutamate transmission\n"
  "    POINT_PROCESS AMPA_S\n"
  "    RANGE g\n"
  "    NONSPECIFIC_CURRENT i : Local current, will not contribute to changes in ionic concentration\n"
  ...
  "\n"
  "PARAMETER {\n"
  "    Cdur = 1.0 (ms) : Transmitter duration. A single presynaptic spike causes a pulse of transmitter in the synaptic cleft \n"
  "    : with fixed duration (Cdur)\n"
  "    Alpha = 1.1 (1/ms) : Binding rate\n"
  "    Beta = 0.19 (1/ms) : Backward (removal) rate\n"
  ...
  "    g (umho) : conductance\n"
  "    Rtau (ms) : time constant of channel binding neurotransmitter\n"
  "    Rinf : Fraction of open channels if transmitter is present in the cleft forever\n"
  "    synon : Sum of weights of all synapses in the on state\n"
  "}\n"
  "\n"
  "STATE {\n"
  "    Ron : Total conductances of all synapses that are ON\n"
  "    Roff : Total conductance of all synapses that are OFF\n"
  "}\n"
  "\n"
  "INITIAL {\n"
  "    synon = 0\n"
